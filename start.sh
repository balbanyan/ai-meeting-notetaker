...
echo "   POST /meetings/register-and-join - Register meeting and trigger bot (embedded app)"
echo "   POST /meetings/test-join         - Test bot join without API calls (development)"
echo "   POST /audio/chunk                - Upload audio chunk from bot"
echo "   POST /events/speaker-started     - Log speaker event from bot"
echo ""
